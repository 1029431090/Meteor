...
if __name__ == '__main__':
    y, sr = sf.read(r'D:\Anaconda\code\数字信号处理\音频文件基本作图\文件\flydog.web-sdr.net_2023-09-13T21_53_14Z_10346.00_usb.wav')
    # 预加重
    ...
    plt.tight_layout()
    plt.savefig(r'D:\Anaconda\code\数字信号处理\音频文件基本作图\文件\111.png',
                dpi=1000)
    # plt.show()
    plt.close()
